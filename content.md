...
-LOGO+Navigation(a single webpage or a landing page)

-Hero section
-Featured in (they are usually right after the hero) or we call it feature row(we understood it is wrong) i can see it in layout section
-how it works
...
-Pricing +features
-Call to action section (CTA) (it is usually the last section before the footer)
-footer
